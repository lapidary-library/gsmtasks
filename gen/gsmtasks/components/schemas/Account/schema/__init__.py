...
class Account(lapidary.runtime.ModelBase):
    ...
    owner: typing.Union[None, str]

    custom_integration_url: typing.Union[None, str]

    feature_geocoding_country_code: typing.Union[None, str, typing.Any]

    feature_tracker_url: typing.Union[None, str]

    feature_route_folders: typing.Union[None, bool]

    feature_route_auto_archive: typing.Union[None, bool]

    dashboard_task_template: typing.Union[None, str]

    calendar_task_template: typing.Union[None, str]

    dashboard_worker_limit: typing.Union[None, int]

    stripe_customer_id: typing.Union[None, str]

    stripe_payment_method_id: typing.Union[None, str]
