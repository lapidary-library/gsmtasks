...
class TaskSerializerV2(lapidary.runtime.ModelBase):
    ...
    duration: typing.Union[None, int, str] = None

    size: typing.Union[None, list[int]] = None

    forms: typing.Union[None, gsmtasks.components.schemas.TaskSerializerV2.properties.forms.schema.forms] = None
    ...
    counts: typing.Union[None, gsmtasks.components.schemas.TaskSerializerV2.properties.counts.schema.counts] = None

    actions: typing.Union[None, list[str]] = None
