...
import gsmtasks.components.schemas.TaskSerializerV2.properties.metafields.schema
import lapidary.runtime
import uuid
...
class TaskSerializerV2(lapidary.runtime.ModelBase):
    ...
    forms: typing.Union[None, gsmtasks.components.schemas.TaskSerializerV2.properties.forms.schema.forms]
    ...
    counts: typing.Union[None, gsmtasks.components.schemas.TaskSerializerV2.properties.counts.schema.counts]

    actions: typing.Union[None, list[str]]
    ...
    TaskDuration: typing.Union[None, int, str] = None
    ...
    metafields: typing.Union[None, gsmtasks.components.schemas.TaskSerializerV2.properties.metafields.schema.metafields] = None
