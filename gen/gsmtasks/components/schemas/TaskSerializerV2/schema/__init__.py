...
class TaskSerializerV2(lapidary.runtime.ModelBase):
    ...
    forms: typing.Annotated[
        typing.Union[None, gsmtasks.components.schemas.TaskSerializerV2.properties.forms.schema.forms],
        pydantic.Field(
            alias='forms',
            direction=lapidary.runtime.ParamDirection.read,
        )
    ...
    counts: typing.Annotated[
        typing.Union[None, gsmtasks.components.schemas.TaskSerializerV2.properties.counts.schema.counts],
        pydantic.Field(
            alias='counts',
            direction=lapidary.runtime.ParamDirection.read,
        )
    ...
    metafields: typing.Annotated[
        typing.Union[None, gsmtasks.components.schemas.TaskSerializerV2.properties.metafields.schema.metafields],
        pydantic.Field(
            alias='metafields',
        )
    ] = None
