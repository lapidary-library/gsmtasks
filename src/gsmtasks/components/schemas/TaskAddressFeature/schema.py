...
class TaskAddressFeature(lapidary.runtime.ModelBase):
    ...
    geometry: typing.Union[
            gsmtasks.components.schemas.TaskAddressFeature.properties.geometry.schema.geometry,
            None,
        ] = None
    
    properties: typing.Union[
            gsmtasks.components.schemas.TaskAddressFeature.properties.properties.schema.properties,
            None,
        ] = None
