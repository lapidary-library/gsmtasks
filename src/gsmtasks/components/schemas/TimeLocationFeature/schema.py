...
class TimeLocationFeature(lapidary.runtime.ModelBase):
    ...
    geometry: typing.Union[
            gsmtasks.components.schemas.TimeLocationFeature.properties.geometry.schema.geometry,
            None,
        ] = None
    
    properties: typing.Union[
            gsmtasks.components.schemas.TimeLocationFeature.properties.properties.schema.properties,
            None,
        ] = None
