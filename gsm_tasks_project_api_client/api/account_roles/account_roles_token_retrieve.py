...
from ...models.account_roles_token_retrieve_format import AccountRolesTokenRetrieveFormat
...
def _get_kwargs(
    ...
    *,
    ...
    format_: Union[Unset, None, AccountRolesTokenRetrieveFormat] = UNSET,
) -> Dict[str, Any]:
    url = "{}/account_roles/{id}/token/".format(client.base_url, id=id)
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        id (str):
        format_ (Union[Unset, None, AccountRolesTokenRetrieveFormat]):
