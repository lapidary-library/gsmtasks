...
from ...models.account_roles_notify_create_format import AccountRolesNotifyCreateFormat
...
def _get_kwargs(
    ...
    *,
    ...
    format_: Union[Unset, None, AccountRolesNotifyCreateFormat] = UNSET,
) -> Dict[str, Any]:
    url = "{}/account_roles/{id}/notify/".format(client.base_url, id=id)
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        id (str):
        format_ (Union[Unset, None, AccountRolesNotifyCreateFormat]):
        json_body (AccountRole):
