...
from ...models.account_roles_update_format import AccountRolesUpdateFormat
...
def _get_kwargs(
    ...
    *,
    ...
    format_: Union[Unset, None, AccountRolesUpdateFormat] = UNSET,
) -> Dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        id (str):
        format_ (Union[Unset, None, AccountRolesUpdateFormat]):
        json_body (AccountRole):
