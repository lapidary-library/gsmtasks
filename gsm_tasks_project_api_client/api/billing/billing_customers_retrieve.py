...
from ...models.billing_customers_retrieve_format import BillingCustomersRetrieveFormat
...
def _get_kwargs(
    ...
    *,
    ...
    format_: Union[Unset, None, BillingCustomersRetrieveFormat] = UNSET,
) -> Dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        id (str):
        format_ (Union[Unset, None, BillingCustomersRetrieveFormat]):
