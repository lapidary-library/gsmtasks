...
from ...models.metafields_update_format import MetafieldsUpdateFormat
...
def _get_kwargs(
    ...
    *,
    ...
    json_body: Metafield,
    format_: Union[Unset, None, MetafieldsUpdateFormat] = UNSET,
) -> Dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        id (str):
        format_ (Union[Unset, None, MetafieldsUpdateFormat]):
        multipart_data (Metafield):
        json_body (Metafield):
