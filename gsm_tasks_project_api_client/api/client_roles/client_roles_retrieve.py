...
from ...models.client_roles_retrieve_format import ClientRolesRetrieveFormat
...
def _get_kwargs(
    ...
    *,
    ...
    format_: Union[Unset, None, ClientRolesRetrieveFormat] = UNSET,
) -> Dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        id (str):
        format_ (Union[Unset, None, ClientRolesRetrieveFormat]):
