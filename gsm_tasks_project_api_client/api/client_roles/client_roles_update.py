...
from ...models.client_roles_update_format import ClientRolesUpdateFormat
...
def _get_kwargs(
    ...
    *,
    ...
    format_: Union[Unset, None, ClientRolesUpdateFormat] = UNSET,
) -> Dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        id (str):
        format_ (Union[Unset, None, ClientRolesUpdateFormat]):
        multipart_data (ClientRole):
        json_body (ClientRole):
