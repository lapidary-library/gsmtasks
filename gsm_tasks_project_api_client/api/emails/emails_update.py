...
from ...models.emails_update_format import EmailsUpdateFormat
...
def _get_kwargs(
    ...
    *,
    ...
    json_body: Email,
    format_: Union[Unset, None, EmailsUpdateFormat] = UNSET,
) -> Dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        id (str):
        format_ (Union[Unset, None, EmailsUpdateFormat]):
        multipart_data (Email):
        json_body (Email):
