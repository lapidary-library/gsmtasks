...
from ...models.push_notifications_update_format import PushNotificationsUpdateFormat
...
def _get_kwargs(
    ...
    *,
    ...
    format_: Union[Unset, None, PushNotificationsUpdateFormat] = UNSET,
) -> Dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        id (str):
        format_ (Union[Unset, None, PushNotificationsUpdateFormat]):
        multipart_data (PushNotification):
        json_body (PushNotification):
