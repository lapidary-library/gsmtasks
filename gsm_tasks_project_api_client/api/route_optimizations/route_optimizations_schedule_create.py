...
from ...models.route_optimizations_schedule_create_format import RouteOptimizationsScheduleCreateFormat
...
def _get_kwargs(
    ...
    *,
    ...
    format_: Union[Unset, None, RouteOptimizationsScheduleCreateFormat] = UNSET,
) -> Dict[str, Any]:
    url = "{}/route_optimizations/{id}/schedule/".format(client.base_url, id=id)
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        id (str):
        format_ (Union[Unset, None, RouteOptimizationsScheduleCreateFormat]):
        json_body (RouteOptimizationSerializerV2):
