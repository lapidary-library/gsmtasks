...
from ...models.route_optimizations_commit_create_format import RouteOptimizationsCommitCreateFormat
...
def _get_kwargs(
    ...
    *,
    ...
    format_: Union[Unset, None, RouteOptimizationsCommitCreateFormat] = UNSET,
) -> Dict[str, Any]:
    url = "{}/route_optimizations/{id}/commit/".format(client.base_url, id=id)
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        id (str):
        format_ (Union[Unset, None, RouteOptimizationsCommitCreateFormat]):
        json_body (RouteOptimizationSerializerV2):
