...
from ...models.route_optimizations_routes_retrieve_format import RouteOptimizationsRoutesRetrieveFormat
...
def _get_kwargs(
    ...
    *,
    ...
    format_: Union[Unset, None, RouteOptimizationsRoutesRetrieveFormat] = UNSET,
) -> Dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        id (str):
        format_ (Union[Unset, None, RouteOptimizationsRoutesRetrieveFormat]):
