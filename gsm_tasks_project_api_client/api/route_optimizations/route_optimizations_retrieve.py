...
from ...models.route_optimizations_retrieve_format import RouteOptimizationsRetrieveFormat
...
def _get_kwargs(
    ...
    *,
    ...
    format_: Union[Unset, None, RouteOptimizationsRetrieveFormat] = UNSET,
) -> Dict[str, Any]:
    url = "{}/route_optimizations/{id}/".format(client.base_url, id=id)
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        id (str):
        format_ (Union[Unset, None, RouteOptimizationsRetrieveFormat]):
