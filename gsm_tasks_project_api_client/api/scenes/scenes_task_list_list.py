...
from ...models.scenes_task_list_list_assignee_proximity import ScenesTaskListListAssigneeProximity
from ...models.scenes_task_list_list_category import ScenesTaskListListCategory
from ...models.scenes_task_list_list_format import ScenesTaskListListFormat
from ...models.scenes_task_list_list_state import ScenesTaskListListState
from ...models.task_list_scene import TaskListScene
...
def _get_kwargs(
    *,
    ...
    assignee_proximity: Union[Unset, None, ScenesTaskListListAssigneeProximity] = UNSET,
    assignee_proximity_in: Union[Unset, None, str] = UNSET,
    category: Union[Unset, None, ScenesTaskListListCategory] = UNSET,
    ...
    format_: Union[Unset, None, ScenesTaskListListFormat] = UNSET,
    ...
    state: Union[Unset, None, ScenesTaskListListState] = UNSET,
    ...
    url = "{}/scenes/task_list/".format(client.base_url)
...
def _parse_response(*, response: httpx.Response) -> Optional[List[TaskListScene]]:
    if response.status_code == 200:
        response_200 = []
        _response_200 = response.json()
        for componentsschemas_paginated_task_list_scene_list_item_data in _response_200:
            componentsschemas_paginated_task_list_scene_list_item = TaskListScene.from_dict(
                componentsschemas_paginated_task_list_scene_list_item_data
            )

            response_200.append(componentsschemas_paginated_task_list_scene_list_item)

        return response_200
    return None


def _build_response(*, response: httpx.Response) -> Response[List[TaskListScene]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        assignee_proximity (Union[Unset, None, ScenesTaskListListAssigneeProximity]):
        assignee_proximity_in (Union[Unset, None, str]):
        category (Union[Unset, None, ScenesTaskListListCategory]):
        ...
        format_ (Union[Unset, None, ScenesTaskListListFormat]):
        ...
        state (Union[Unset, None, ScenesTaskListListState]):
