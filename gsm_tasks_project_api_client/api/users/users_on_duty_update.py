...
from ...models.users_on_duty_update_format import UsersOnDutyUpdateFormat
...
def _get_kwargs(
    ...
    *,
    ...
    json_body: OnDuty,
    format_: Union[Unset, None, UsersOnDutyUpdateFormat] = UNSET,
) -> Dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        id (str):
        format_ (Union[Unset, None, UsersOnDutyUpdateFormat]):
        json_body (OnDuty):
