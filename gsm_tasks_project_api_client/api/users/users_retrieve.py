...
from ...models.users_retrieve_format import UsersRetrieveFormat
...
def _get_kwargs(
    ...
    *,
    ...
    format_: Union[Unset, None, UsersRetrieveFormat] = UNSET,
) -> Dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        id (str):
        format_ (Union[Unset, None, UsersRetrieveFormat]):
