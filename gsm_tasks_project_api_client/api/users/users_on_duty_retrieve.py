...
from ...models.users_on_duty_retrieve_format import UsersOnDutyRetrieveFormat
...
def _get_kwargs(
    ...
    *,
    ...
    format_: Union[Unset, None, UsersOnDutyRetrieveFormat] = UNSET,
) -> Dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        id (str):
        format_ (Union[Unset, None, UsersOnDutyRetrieveFormat]):
