...
from ...models.users_destroy_format import UsersDestroyFormat
...
def _get_kwargs(
    ...
    *,
    ...
    format_: Union[Unset, None, UsersDestroyFormat] = UNSET,
) -> Dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        id (str):
        format_ (Union[Unset, None, UsersDestroyFormat]):
