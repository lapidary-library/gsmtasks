...
from ...models.users_partial_update_format import UsersPartialUpdateFormat
...
def _get_kwargs(
    ...
    *,
    ...
    format_: Union[Unset, None, UsersPartialUpdateFormat] = UNSET,
) -> Dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        id (str):
        format_ (Union[Unset, None, UsersPartialUpdateFormat]):
