...
from ...models.notification_templates_create_format import NotificationTemplatesCreateFormat
...
def _get_kwargs(
    *,
    ...
    format_: Union[Unset, None, NotificationTemplatesCreateFormat] = UNSET,
) -> Dict[str, Any]:
...
def _parse_response(*, response: httpx.Response) -> Optional[NotificationTemplate]:
    if response.status_code == 201:
        response_201 = NotificationTemplate.from_dict(response.json())
...
def sync_detailed(
    *,
    ...
    """
    Args:
        format_ (Union[Unset, None, NotificationTemplatesCreateFormat]):
        multipart_data (NotificationTemplate):
        json_body (NotificationTemplate):
