...
from ...models.notification_templates_retrieve_format import NotificationTemplatesRetrieveFormat
...
def _get_kwargs(
    ...
    *,
    ...
    format_: Union[Unset, None, NotificationTemplatesRetrieveFormat] = UNSET,
) -> Dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        id (str):
        format_ (Union[Unset, None, NotificationTemplatesRetrieveFormat]):
