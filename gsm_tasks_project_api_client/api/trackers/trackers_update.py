...
from ...models.trackers_update_format import TrackersUpdateFormat
...
def _get_kwargs(
    ...
    *,
    ...
    json_body: Tracker,
    format_: Union[Unset, None, TrackersUpdateFormat] = UNSET,
) -> Dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        id (str):
        format_ (Union[Unset, None, TrackersUpdateFormat]):
        multipart_data (Tracker):
        json_body (Tracker):
