...
from ...models.tasks_events_retrieve_format import TasksEventsRetrieveFormat
...
def _get_kwargs(
    ...
    *,
    ...
    format_: Union[Unset, None, TasksEventsRetrieveFormat] = UNSET,
) -> Dict[str, Any]:
    url = "{}/tasks/{id}/events/".format(client.base_url, id=id)
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        id (str):
        format_ (Union[Unset, None, TasksEventsRetrieveFormat]):
