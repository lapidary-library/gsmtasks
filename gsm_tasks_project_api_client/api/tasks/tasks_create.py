...
from ...models.tasks_create_format import TasksCreateFormat
...
def _get_kwargs(
    *,
    ...
    format_: Union[Unset, None, TasksCreateFormat] = UNSET,
) -> Dict[str, Any]:
...
def _parse_response(*, response: httpx.Response) -> Optional[TaskSerializerV2]:
    if response.status_code == 201:
        response_201 = TaskSerializerV2.from_dict(response.json())
...
def sync_detailed(
    *,
    ...
    """
    Args:
        format_ (Union[Unset, None, TasksCreateFormat]):
        json_body (TaskSerializerV2):
