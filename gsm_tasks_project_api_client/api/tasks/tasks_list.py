...
from ...models.tasks_list_assignee_proximity import TasksListAssigneeProximity
from ...models.tasks_list_category import TasksListCategory
from ...models.tasks_list_format import TasksListFormat
from ...models.tasks_list_state import TasksListState
...
def _get_kwargs(
    *,
    ...
    assignee_proximity: Union[Unset, None, TasksListAssigneeProximity] = UNSET,
    assignee_proximity_in: Union[Unset, None, str] = UNSET,
    category: Union[Unset, None, TasksListCategory] = UNSET,
    ...
    format_: Union[Unset, None, TasksListFormat] = UNSET,
    ...
    state: Union[Unset, None, TasksListState] = UNSET,
...
def _parse_response(*, response: httpx.Response) -> Optional[List[TaskSerializerV2]]:
    if response.status_code == 200:
        response_200 = []
        _response_200 = response.json()
        for componentsschemas_paginated_task_serializer_v2_list_item_data in _response_200:
            componentsschemas_paginated_task_serializer_v2_list_item = TaskSerializerV2.from_dict(
                componentsschemas_paginated_task_serializer_v2_list_item_data
            )

            response_200.append(componentsschemas_paginated_task_serializer_v2_list_item)

        return response_200
    return None


def _build_response(*, response: httpx.Response) -> Response[List[TaskSerializerV2]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    unassignee_id_in: Union[Unset, None, str] = UNSET,
    unassignee_id_isnull: Union[Unset, None, str] = UNSET,
) -> Response[List[TaskSerializerV2]]:
    """
    Args:
        ...
        assignee_proximity (Union[Unset, None, TasksListAssigneeProximity]):
        assignee_proximity_in (Union[Unset, None, str]):
        category (Union[Unset, None, TasksListCategory]):
        ...
        format_ (Union[Unset, None, TasksListFormat]):
        ...
        state (Union[Unset, None, TasksListState]):
...
def sync(
    *,
    ...
    unassignee_id_in: Union[Unset, None, str] = UNSET,
    unassignee_id_isnull: Union[Unset, None, str] = UNSET,
) -> Optional[List[TaskSerializerV2]]:
    """
    Args:
        address_apartment_number (Union[Unset, None, str]):
        address_apartment_number_icontains (Union[Unset, None, str]):
