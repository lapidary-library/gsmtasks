...
from ...models.tasks_documents_retrieve_format import TasksDocumentsRetrieveFormat
...
def _get_kwargs(
    ...
    *,
    ...
    format_: Union[Unset, None, TasksDocumentsRetrieveFormat] = UNSET,
) -> Dict[str, Any]:
    url = "{}/tasks/{id}/documents/".format(client.base_url, id=id)
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        id (str):
        format_ (Union[Unset, None, TasksDocumentsRetrieveFormat]):
