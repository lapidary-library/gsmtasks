...
from ...models.webhooks_create_format import WebhooksCreateFormat
...
def _get_kwargs(
    *,
    ...
    json_body: Webhook,
    format_: Union[Unset, None, WebhooksCreateFormat] = UNSET,
) -> Dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    """
    Args:
        format_ (Union[Unset, None, WebhooksCreateFormat]):
        multipart_data (Webhook):
        json_body (Webhook):
