...
from ...models.webhooks_update_format import WebhooksUpdateFormat
...
def _get_kwargs(
    ...
    *,
    ...
    json_body: Webhook,
    format_: Union[Unset, None, WebhooksUpdateFormat] = UNSET,
) -> Dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        id (str):
        format_ (Union[Unset, None, WebhooksUpdateFormat]):
        multipart_data (Webhook):
        json_body (Webhook):
