...
from ...models.webhooks_retrieve_format import WebhooksRetrieveFormat
...
def _get_kwargs(
    ...
    *,
    ...
    format_: Union[Unset, None, WebhooksRetrieveFormat] = UNSET,
) -> Dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        id (str):
        format_ (Union[Unset, None, WebhooksRetrieveFormat]):
