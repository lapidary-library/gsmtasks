...
from ...models.task_commands_update_format import TaskCommandsUpdateFormat
...
def _get_kwargs(
    ...
    *,
    ...
    format_: Union[Unset, None, TaskCommandsUpdateFormat] = UNSET,
) -> Dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        id (str):
        format_ (Union[Unset, None, TaskCommandsUpdateFormat]):
        multipart_data (TaskCommand):
        json_body (TaskCommand):
