...
from ...models.users_on_duty_log_create_format import UsersOnDutyLogCreateFormat
...
def _get_kwargs(
    *,
    ...
    format_: Union[Unset, None, UsersOnDutyLogCreateFormat] = UNSET,
) -> Dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    """
    Args:
        format_ (Union[Unset, None, UsersOnDutyLogCreateFormat]):
        multipart_data (WorkingState):
        json_body (WorkingState):
