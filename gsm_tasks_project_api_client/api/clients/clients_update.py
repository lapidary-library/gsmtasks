...
from ...models.clients_update_format import ClientsUpdateFormat
...
def _get_kwargs(
    ...
    *,
    ...
    json_body: Client,
    format_: Union[Unset, None, ClientsUpdateFormat] = UNSET,
) -> Dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        id (str):
        format_ (Union[Unset, None, ClientsUpdateFormat]):
        multipart_data (Client):
        json_body (Client):
