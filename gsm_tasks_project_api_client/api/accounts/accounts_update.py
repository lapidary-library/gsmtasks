...
from ...models.accounts_update_format import AccountsUpdateFormat
...
def _get_kwargs(
    ...
    *,
    ...
    form_data: Account,
    multipart_data: Account,
    json_body: Account,
    format_: Union[Unset, None, AccountsUpdateFormat] = UNSET,
) -> Dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        id (str):
        format_ (Union[Unset, None, AccountsUpdateFormat]):
        multipart_data (Account):
        json_body (Account):
