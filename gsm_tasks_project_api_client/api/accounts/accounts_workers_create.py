...
from ...models.accounts_workers_create_format import AccountsWorkersCreateFormat
...
def _get_kwargs(
    ...
    *,
    ...
    format_: Union[Unset, None, AccountsWorkersCreateFormat] = UNSET,
) -> Dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        id (str):
        format_ (Union[Unset, None, AccountsWorkersCreateFormat]):
        multipart_data (AccountUser):
        json_body (AccountUser):
