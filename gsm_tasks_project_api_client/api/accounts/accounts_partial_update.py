...
from ...models.accounts_partial_update_format import AccountsPartialUpdateFormat
...
def _get_kwargs(
    ...
    *,
    ...
    form_data: PatchedAccount,
    multipart_data: PatchedAccount,
    json_body: PatchedAccount,
    format_: Union[Unset, None, AccountsPartialUpdateFormat] = UNSET,
) -> Dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        id (str):
        format_ (Union[Unset, None, AccountsPartialUpdateFormat]):
        multipart_data (PatchedAccount):
        json_body (PatchedAccount):
