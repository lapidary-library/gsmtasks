...
from ..models.task_duration import TaskDuration
from ..models.task_forms import TaskForms
from ..models.task_metafields import TaskMetafields
...
class Task:
    ...
    Attributes:
        ...
        duration (Union[Unset, None, TaskDuration]):
        size (Union[Unset, None, List[int]]):
        is_full_load (Union[Unset, bool]):
        metafields (Union[Unset, TaskMetafields]):
        forms (Union[Unset, TaskForms]):
    """
    ...
    duration: Union[Unset, None, TaskDuration] = UNSET
    size: Union[Unset, None, List[int]] = UNSET
    is_full_load: Union[Unset, bool] = UNSET
    metafields: Union[Unset, TaskMetafields] = UNSET
    forms: Union[Unset, TaskForms] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if _duration is None:
            ...
            duration = TaskDuration.from_dict(_duration)
        ...
        if isinstance(_metafields, Unset):
            ...
            metafields = TaskMetafields.from_dict(_metafields)
        ...
        if isinstance(_forms, Unset):
            ...
            forms = TaskForms.from_dict(_forms)
