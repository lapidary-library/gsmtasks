...
from ..models.account_default_task_duration import AccountDefaultTaskDuration
from ..models.account_rotate_assignee import AccountRotateAssignee
from ..models.account_task_expiry_duration import AccountTaskExpiryDuration
...
class Account:
    ...
    Attributes:
        ...
        slug (str):
        owner (str):
        feature_change_task_account (bool):
        feature_geocoding_country_code (Union[BlankEnum, FeatureGeocodingCountryCodeEnum]): Limit geocoding to the
            selected country.
        ...
        billing_method (AccountBillingMethodEnum):
        ...
        task_duration (Union[Unset, AccountDefaultTaskDuration]):
        task_expiry_duration (Union[Unset, None, AccountTaskExpiryDuration]):
        ...
        auto_assign_rotate (Union[Unset, None, AccountRotateAssignee]): Time after non-accepted task assignees will be
            rotated. Leave empty in case the orders should not be rotated
    ...
    owner: str
    feature_change_task_account: bool
    feature_geocoding_country_code: Union[BlankEnum, FeatureGeocodingCountryCodeEnum]
    dashboard_task_template: str
    dashboard_worker_limit: int
    managers: str
    workers: str
    ...
    task_duration: Union[Unset, AccountDefaultTaskDuration] = UNSET
    task_expiry_duration: Union[Unset, None, AccountTaskExpiryDuration] = UNSET
    ...
    auto_assign_rotate: Union[Unset, None, AccountRotateAssignee] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if isinstance(self.feature_geocoding_country_code, FeatureGeocodingCountryCodeEnum):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        feature_change_task_account = d.pop("feature_change_task_account")

        def _parse_feature_geocoding_country_code(data: object) -> Union[BlankEnum, FeatureGeocodingCountryCodeEnum]:
            try:
                if not isinstance(data, str):
                    raise TypeError()
                feature_geocoding_country_code_type_0 = FeatureGeocodingCountryCodeEnum(data)
            ...
            if not isinstance(data, str):
                raise TypeError()
            feature_geocoding_country_code_type_1 = BlankEnum(data)

            return feature_geocoding_country_code_type_1

        feature_geocoding_country_code = _parse_feature_geocoding_country_code(d.pop("feature_geocoding_country_code"))

        dashboard_task_template = d.pop("dashboard_task_template")

        dashboard_worker_limit = d.pop("dashboard_worker_limit")

        managers = d.pop("managers")
        ...
        billing_method = AccountBillingMethodEnum(d.pop("billing_method"))
        ...
        if isinstance(_task_duration, Unset):
            ...
            task_duration = AccountDefaultTaskDuration.from_dict(_task_duration)
        ...
        if _task_expiry_duration is None:
            ...
            task_expiry_duration = AccountTaskExpiryDuration.from_dict(_task_expiry_duration)
        ...
        auto_assign_rotate: Union[Unset, None, AccountRotateAssignee]
        if _auto_assign_rotate is None:
            auto_assign_rotate = None
        elif isinstance(_auto_assign_rotate, Unset):
            auto_assign_rotate = UNSET
        else:
            auto_assign_rotate = AccountRotateAssignee.from_dict(_auto_assign_rotate)
