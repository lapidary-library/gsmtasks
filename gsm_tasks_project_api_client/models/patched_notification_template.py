...
T = TypeVar("T", bound="PatchedNotificationTemplate")


@attr.s(auto_attribs=True)
class PatchedNotificationTemplate:
    """
    Attributes:
        id (Union[Unset, str]):
        url (Union[Unset, str]):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        patched_notification_template = cls(
            id=id,
            url=url,
            account=account,
            name=name,
        ...
        patched_notification_template.additional_properties = d
        return patched_notification_template
