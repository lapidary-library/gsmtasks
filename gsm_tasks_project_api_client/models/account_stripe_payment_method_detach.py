...
T = TypeVar("T", bound="AccountStripePaymentMethodDetach")


@attr.s(auto_attribs=True)
class AccountStripePaymentMethodDetach:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        account_stripe_payment_method_detach = cls(
            stripe_payment_method_id=stripe_payment_method_id,
        )

        account_stripe_payment_method_detach.additional_properties = d
        return account_stripe_payment_method_detach
