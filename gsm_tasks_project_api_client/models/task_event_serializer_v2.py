...
from ..models.task_event_serializer_v2_location import TaskEventSerializerV2Location
from ..models.task_serializer_v2 import TaskSerializerV2
from ..models.to_state_enum import ToStateEnum
from ..types import UNSET, Unset

T = TypeVar("T", bound="TaskEventSerializerV2")


@attr.s(auto_attribs=True)
class TaskEventSerializerV2:
    """
    Attributes:
        id (str):
        url (str):
        account (str):
        task (TaskSerializerV2):
        task_command (str):
        ...
        location (Union[Unset, None, TaskEventSerializerV2Location]):
    """
    ...
    location: Union[Unset, None, TaskEventSerializerV2Location] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        task = TaskSerializerV2.from_dict(d.pop("task"))
        ...
        if _location is None:
            ...
            location = TaskEventSerializerV2Location.from_dict(_location)

        task_event_serializer_v2 = cls(
            id=id,
            url=url,
            account=account,
            task=task,
        ...
        task_event_serializer_v2.additional_properties = d
        return task_event_serializer_v2
